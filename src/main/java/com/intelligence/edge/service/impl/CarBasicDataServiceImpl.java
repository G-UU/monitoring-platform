...
public class CarBasicDataServiceImpl implements CarBasicDataService {
    ...
    @Override
    public List<CarBasicData> getAllUavBasicData() {
        return carBasicDataMapper.getAllUavBasicData();
    }
    ...
    public CarBasicData getCarBasicDataByID(String carID) {
        ...
        System.out.println(CarTempData.carPos.get(carID).getLongitude());
        car.setLongitude(CarTempData.carPos.get(carID).getLongitude());
        car.setLatitude(CarTempData.carPos.get(carID).getLatitude());
        return car;
    }
    ...
    public String getVideoAddressByID(String deviceID)
    {
        return carBasicDataMapper.getVideoAddressByID(deviceID);
    }

    @Override
    public DeviceTravelData getDeviceTravelDataById(String deviceId) {
        return carBasicDataMapper.getDeviceTravelDataById(deviceId);
    }
