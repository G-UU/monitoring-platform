...
@Data
@Slf4j(topic = "u.UavVideoServer")
public class UavVideoServer {
    ...
    public UavVideoServer(String deviceID, int port) throws IOException {
    ...
    public void start() throws IOException {
        ...
        socketThread = new Thread(new UavVideoServer.Task(socket));
        socketThread.start();
    ...
    class Task implements Runnable{
        ...
        public void run() {
            ...
            String fileDir = "/home/ubuntu/test/storage/";
            //String fileDir = "/home/ubuntu/test/storage/";
            try {
                DatagramPacket packet = new DatagramPacket(buf, buf.length);
                log.info(deviceID+": 文件数据接收端打开!");
                while (runFlag) {
                    ...
                    fileName = new String(buf).trim();
                    String fileDir_tmp = fileDir + deviceID;
